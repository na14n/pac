    ...
    return (
        <div className='w-full h-full lg:px-32 2xl:px-48 flex flex-col items-center justify-center py-16 max-lg:py-8'>
            ...
            <div className="embla h-fit w-full overflow-hidden relative flex items-center justify-center gap-4 `" >
                ...
                <div className="embla__viewport self-center h-full w-full flex justify-center items-center `" ref={emblaRef}>
                    <div className="embla__container h-full w-full ">
                        {arrayOfArrays.map((w, index) => (
                            <div key={index} className='embla__slide w-full h-full grid justify-items-center xs:grid-cols-2 lg:grid-cols-5 py-8 gap-2 lg:gap-x-16'>
                                {w.map((c, index) => (
