...
const QuotationGUide = ({ props }) => {
    ...
    return (
        <div className="w-full h-full max-h-fit flex flex-col justify-center items-center gap-8 py-12 lg:px-32 2xl:px-48">
            <h1 className="w-fit h-fit lg:text-3xl 2xl:text-5xl text-[#121212] font-bold">
                Quotation Inquiry Guide
            </h1>
            <div className="grid grid-cols-4 bg-[#DFDFDF] py-2 rounded-md divide-x-[2px] divide-[#D1D1D1] border-2 border-[#D1D1D1]">
