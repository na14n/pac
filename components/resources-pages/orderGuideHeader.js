        ...
        <section className="relative w-full h-fit aspect-[2/2] md:aspect-[16/4] flex items-center justify-center overflow-hidden z-0">
            ...
            <div className="w-full h-full z-10 flex max-md:flex-col-reverse items-center justify-center max-md:mt-48">
                <div className="self-stretch w-full h-full relative">
                    <Image fill src={data?.contactUsContents?.nodes[0]?.mediaLine1[0] ? data?.contactUsContents?.nodes[0]?.mediaLine1[0]?.sourceUrl : 'https://picsum.photos/1920/1080'} className='object-contain md:object-cover object-left-bottom md:object-center' alt="dental-website-banner" />
                </div>
