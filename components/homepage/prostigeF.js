...
export default function ProstigeF(props) {
  ...
  return (
    <section className="flex flex-col gap-8 xs:py-20 lg:py-16 xs:px-4 lg:px-32 2xl:px-48">
      <div className="w-full h-full flex xs:flex-col-reverse lg:flex-row xs:justify-center lg:justify-between xs:items-center lg:items-center lg:gap-12 xs:gap-24 ">
        <div className="md:max-w-lg max-w-full flex flex-col gap-8 ">
          <div className="flex flex-col justify-end gap-1 relative w-80 h-[90px]">
        ...
        <div className="2xl:w-[640px] 2xl:h-[360px] xs:w-64 xs:h-36 lg:w-[448px] lg:h-[280px] rotate-12 shadow-md rounded-3xl overflow-hidden">
