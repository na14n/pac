...
export async function EventsF() {
    return (
        <div className="w-full max-h-fit lg:h-full 2xl:h-fit bg-[#EFEFEF] flex flex-col 2xl:justify-between lg:justify-center items-center lg:px-32 2xl:px-48 2xl:py-32 lg:gap-16 2xl:gap-32 xs:px-4 xs:pb-16 lg:pb-0">
