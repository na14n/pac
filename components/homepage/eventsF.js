...
export default function EventsF() {
    ...
    return (
        <div className="w-full max-h-fit h-fit bg-[#EFEFEF] flex flex-col lg:justify-center items-center lg:px-32 2xl:px-48 2xl:py-32 lg:gap-8 2xl:gap-32 xs:px-4  py-12 ">
            <div className="lg:max-w-full min-w-fit flex flex-col gap-4 h-fit ">
            ...
            <div className=" lg:max-w-[900px] flex flex-col gap-2 ">
