...
export default function AboutF() {
    ...
    return (
        <div className=" max-h-fit relative lg:px-32 2xl:px-48 lg:py-16 2xl:py-36 lg:min-h-[50vh] xs:px-4 xs:py-20 xs:flex xs:flex-col xs:items-center lg:items-start lg:justify-center xs:gap-8 xs:overflow-hidden lg:overflow-visible">
            ...
            <div className="text-[#121212] lg:max-w-[750px] lg:mb-36 2xl:mb-32 2xl:max-w-[850px] 2xl:text-xl xs:text-sm text-justify indent-7">
