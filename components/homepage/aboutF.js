...
export default function AboutF() {
    ...
    return (
        <div className="h-fit max-h-fit relative lg:px-16 xl:px-32 2xl:px-48 lg:py-16 lg:min-h-[50vh] xs:px-4 xs:py-20 xs:flex xs:flex-col lg:flex-row xs:items-center lg:items-center lg:justify-start xs:gap-8 xs:overflow-hidden lg:overflow-visible">
            ...
            <div className="text-[#121212] lg:max-w-[55ch] 2xl:max-w-[75ch] xl:mb-40 2xl:mb-36 2xl:text-2xl xs:text-sm text-justify xl:ml-28">
