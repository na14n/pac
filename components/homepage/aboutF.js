...
export default function AboutF() {
    ...
    return (
        <div className=" max-h-fit relative lg:px-32 2xl:px-48 lg:py-16 2xl:py-36 lg:min-h-[50vh] xs:px-4 xs:py-20 xs:flex xs:flex-col xs:items-center lg:items-start xs:gap-8 xs:overflow-hidden lg:overflow-visible ">
            <div className="xs:w-48 xs:h-48 xs:relative lg:w-80 lg:h-80 2xl:w-96 2xl:h-96 rounded-md lg:absolute lg:-top-32 lg:right-32 2xl:right-48 overflow-hidden">
                <Image fill={true} alt="dental-products-distributor" src={data?.homepageSections?.nodes[0] ? data?.homepageSections?.nodes[0]?.mediaLine1[0]?.link : 'https://picsum.photos/600/800'} />
            </div>
