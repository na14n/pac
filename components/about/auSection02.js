...
export default function AboutS02() {
    ...
    return (
        <section className="w-full h-fit relative flex flex-col max-xl:items-center justify-between bg-[#EFEFEF] xl:flex-row">
            <div className="w-fit h-fit py-8 xl:py-16 shrink-0 flex flex-col items-center xl:items-start gap-6 xl:gap-8 px-4 md:px-8 lg:px-16 xl:px-32 2xl:pl-48 bg-[#f37f1f]">
