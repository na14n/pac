const FaciCard = ({ title, description, image, alttext }) => {
    return (
      <div>
        <div className=" w-60 h-72 rounded-md shadow-md group overflow-hidden relative flex justify-center items-center">
          ...
          <div className="absolute z-10 t-0 w-72 h-96 flex justify-center items-center">
            <img
              ...
              alt={alttext}
            />
            <h3 className=" w-full font-bold text-xl absolute text-center bottom-12 align-middle drop-shadow-xl group-hover:hidden text-white h-10 bg-gradient-to-t from-pac-charcoal to-transparent">{title}</h3>
          </div>
