        ...
        <section className="w-full h-fit flex flex-col items-center">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48 gap-y-8">
                ...
                <div className="w-full aspect-[3/4] p-8 flex flex-col gap-8 justify-center">
                    <span className="text-sm min-[1700px]:text-lg">{parse(data?.contactUsContents?.nodes[0]?.contentLine1[0])}</span>
                ...
                <div className="w-full aspect-[3/4] p-8 flex flex-col gap-8 justify-center">
                    <span className="text-sm min-[1700px]:text-lg">{parse(data?.contactUsContents?.nodes[0]?.contentLine1[1])}</span>
                    <div className="flex items-center gap-4">
                        <span className="w-16 h-16 min-[1700px]:w-20 min-[1700px]:h-20 rounded-full overflow-hidden relative">
                ...
                <div className="w-full aspect-[3/4] p-8 flex flex-col gap-8 justify-center">
                    <span className="text-sm min-[1700px]:text-lg">{parse(data?.contactUsContents?.nodes[0]?.contentLine1[2])}</span>
                    <div className="flex items-center gap-4">
                        <span className="w-16 h-16 min-[1700px]:w-20 min-[1700px]:h-20 rounded-full overflow-hidden relative">
                ...
                <div className="w-full aspect-[3/4] p-8 flex flex-col gap-8 justify-center">
                    <span className="text-sm min-[1700px]:text-lg">{parse(data?.contactUsContents?.nodes[0]?.contentLine1[3])}</span>
                    <div className="flex items-center gap-4">
                        <span className="w-16 h-16 min-[1700px]:w-20 min-[1700px]:h-20 rounded-full overflow-hidden relative">
