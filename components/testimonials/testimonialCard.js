...
const TestimonialCard = () => {
    return (
        <div className="w-80 h-fit relative flex flex-col items-center">
            ...
            <div className="w-full h-72  px-4 py-4 bg-[#FCFCFC] rounded-md shadow-md">
            ...
            <div className="w-full h-fit mt-2 flex flex-col justify-center items-end">
                <div className="font-bold text-pac-green">
                    Dr. Margaret Jugueta
                </div>
                <div className="text-sm font-semibold text-[#373737]">
