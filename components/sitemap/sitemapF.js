...
export default function SitemapF() {
  return (
    <div className="bg-cover items-start flex-col justify-center relative mt-10 bg-[url('https://cdn-res.keymedia.com/cdn-cgi/image/f=auto/https://cdn-res.keymedia.com/cms/images/ca/120/0395_637834761430417755.jpg')] h-auto w-screen">
      ...
      <div className="bg-pac-orange rounded-2xl w-1/2 h-auto ml-10 text-left mt-10 p-5 gap-5 opacity-90 mb-16">
