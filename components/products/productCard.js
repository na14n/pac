...
const ProductCard = ({ media, name, brand, category, slug, best }) => {
    return (
        <a className="z-10 rounded-sm overflow-hidden bg-[#FCFCFC] shadow-sm w-fit h-fit relative  flex flex-col items-center justify-end group hover:-translate-y-1 hover:shadow-lg transition-all" href={slug ? slug : '/'}>
