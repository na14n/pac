...
export default function TrPageTitle() {
  ...
  return (
    <section className="w-full h-fit bg-gradient-to-b from-[#f9a03c] to-[#ef6703] pt-24 pb-16 flex flex-col justify-end items-center relative">
      <Image
      ...
      <div className="w-32 h-[4px] rounded-full bg-[#007811] z-10" />
