        ...
        <div className="w-full h-fit grid grid-cols-1 md:grid-cols-2">
            {data?.events?.nodes[0]?.shortDescription[0] ?
                ...
                >
                    ...
                    <div className="w-1/2 h-full square flex flex-col justify-center max-md:items-center px-8 md:px-12 gap-8 bg-gradient-to-r from-[#faf0e8] to-white">
                        <h3 className="text-xl 2xl:text-3xl font-bold text-black">
                            {data?.events?.nodes[0]?.shortDescription[0]}
                        </h3>
            ...
            {data?.events?.nodes[0]?.shortDescription[1] ?
                ...
                >
                    ...
                    <div className="w-1/2 h-full square flex flex-col justify-center max-md:items-center px-8 md:px-12 gap-8 bg-gradient-to-r to-[#dcfdde] from-white">
                        <h3 className="text-xl 2xl:text-3xl font-bold text-black">
                            {data?.events?.nodes[0]?.shortDescription[1]}
                        </h3>
