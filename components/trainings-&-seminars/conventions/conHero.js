...
export default function ConHero({ id }) {
    ...
    return (
        <section className="w-full aspect-video lg:aspect-[16/3] flex flex-col py-4 items-start justify-end px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-48 relative">
            ...
            <div className="w-fit flex flex-col gap-2 z-20">
                <a className="text-white/75 font-semibold mb-1 text-sm hover:text-white hover:underline transition-all flex items-center" href="/trainings-&-seminars/conventions">
                    <Icon icon="mdi:chevron-left" className="text-lg" />
                    Return to Conventions List
                </a>
