...
const Button = ({ type, name, link }) => {
    return (
        (type === 1) ? (
            ...
            <a className="group w-fit px-2 py-1 rounded-md bg-size-200 bg-pos-0 bg-gradient-to-b from-[#E05B25] via-[#FD8F29] to-[#E05B25] shadow-sm hover:shadow-xl hover:bg-pos-100 transition-all duration-500" target='_blank' href={link} download={name}>
                <div className="pl-1 text-sm font-semibold text-[#F1F1F1] flex items-center">
