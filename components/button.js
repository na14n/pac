...
const Button = ({ type, name }) => {
    return (
        (type === 1) ? (
            <button className="group ring-2 min-w-content ring-white py-1 px-2 rounded-md hover:ring-nav-orange grow-0 shrink-0">
            ...
            <button className="group p-1rounded-md bg-size-200 bg-pos-0 bg-gradient-to-b from-[#E05B25] via-[#FD8F29] to-[#E05B25] shadow-sm hover:shadow-xl hover:bg-pos-100 transition-all duration-500">
                <div className="pl-1 text-sm font-semibold text-[#F1F1F1] flex items-center">
                    <span className='text-[#F1F1F1] group-hover:text=[#FFFFFF]'>{name}</span>
