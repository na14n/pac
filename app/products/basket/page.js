    ...
    return (
        <PageWrapper>
            <div className="w-full min-h-screen h-fit flex flex-col gap-0 justify-start items-center relative z-0 bg-[#EFEFEF]">
                ...
                <section className="w-full aspect-video md:aspect-[8/5] xl:min-h-[40vh] h-fit flex flex-col items-center justify-center">
                    <h1 className="text-4xl text-[#FCFCFC] text-center uppercase font-bold xl:pt-16 pb-8 z-10 mt-24">
                        Request for Quotation
                    </h1>
                </section>
                <div className=" absolute top-0 w-full aspect-video md:aspect-[8/5] xl:h-[50vh] bg-[#005f19] z-0" />
