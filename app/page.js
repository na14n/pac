...
export default function Home() {
  return (
    <main className="w-full flex flex-col items-center justify-center">
      ...
      <div className='w-full min-h-min h-[100vh] max-h-fit bg-[#F1F1F1]'>
        <BrandsF />
      </div>
      ...
      <div className='w-full min-h-fit max-h-fit bg-[#F1F1F1]'>
        <Hero heroType={'centered3'} title={'want to order?'} subheading={'To know more about our purchase and delivery information'} buttonName={'Click Here'} buttonLink={'/#'} />
      </div>
    </main>
  )
}
